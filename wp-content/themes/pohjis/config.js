...
module.exports = {
	...
	// Project options.
	project: 'Pohjis',           // Project Name.
	projectURL: 'pohjis.test/', // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
	...
	// Translation options.
	textDomain: 'pohjis',          // Your textdomain here.
	translationFile: 'pohjis.pot', // Name of the transalation file.
	translationDST: './languages', // Where to save the translation files.
	packageName: 'Pohjis',         // Package name.
